...
usa un auto refresh cada 6 horas en el hipotetico caso que se produzcan actualizaciones en el backend pra que se actulice los datos de las tablas ROOM DATABASE SQLITE
